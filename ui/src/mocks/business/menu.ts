...
const templateDemoMenuCodePrefixes = ['default:dashboard', 'default:page-demo', 'default:feat', 'default:comp', 'default:level', 'blank:other-login'] as const;
const templateDemoMenuCodes = new Set(['default:about', 'blank:empty-page']);

function isTemplateDemoMenuCode(code: string): boolean {
  return templateDemoMenuCodes.has(code) || templateDemoMenuCodePrefixes.some(prefix => code === prefix || code.startsWith(`${prefix}:`));
}
...
const energyRentalMockMenus: Menu[] = [
  {
    id: 2000,
    fatherId: 0,
    menuName: '\u673A\u5668\u4EBA\u63A7\u5236',
    ...
    alIcon: '',
    icon: 'thunderbolt',
    path: '/default/energy-rental',
    code: 'default:energy-rental',
    orderNum: 1,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'dashboard',
    path: '/default/energy-rental/dashboard',
    code: 'default:energy-rental:dashboard',
    orderNum: 1,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'robot',
    path: '/default/energy-rental/bot-config',
    code: 'default:energy-rental:bot-config',
    orderNum: 2,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'transaction',
    path: '/default/energy-rental/agent-recharge',
    code: 'default:energy-rental:agent-recharge',
    orderNum: 3,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'setting',
    path: '/default/energy-rental/platform-config',
    code: 'default:energy-rental:platform-config',
    orderNum: 4,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'experiment',
    path: '/default/energy-rental/link-test',
    code: 'default:energy-rental:link-test',
    orderNum: 5,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'profile',
    path: '/default/energy-rental/packages',
    code: 'default:energy-rental:packages',
    orderNum: 6,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    icon: '',
    path: '',
    code: 'default:energy-rental:packages:add',
    orderNum: 1,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    icon: '',
    path: '',
    code: 'default:energy-rental:packages:edit',
    orderNum: 2,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    icon: '',
    path: '',
    code: 'default:energy-rental:packages:del',
    orderNum: 3,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'environment',
    path: '/default/energy-rental/address-management',
    code: 'default:energy-rental:addresses',
    orderNum: 7,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'ordered-list',
    path: '/default/energy-rental/orders',
    code: 'default:energy-rental:orders',
    orderNum: 8,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'wallet',
    path: '/default/energy-rental/wallet-transactions',
    code: 'default:energy-rental:wallet-transactions',
    orderNum: 9,
    status: true,
    newLinkFlag: false,
    visible: true
  },
  {
    ...
    alIcon: '',
    icon: 'sync',
    path: '/default/energy-rental/return-tasks',
    code: 'default:energy-rental:return-tasks',
    orderNum: 10,
    status: true,
    newLinkFlag: false,
    visible: true
...
menus = [...menus.filter(menu => !isTemplateDemoMenuCode(menu.code)), ...energyRentalMockMenus];

let nextId = Math.max(...menus.map(menu => menu.id)) + 1;

export const menu = [
  http.post('/site/api/auth/menu', async ({ request }) => {
    const authCodes = (await request.json()) as string[];
    const effectiveCodes = Array.isArray(authCodes) ? new Set(authCodes) : null;
    const list = effectiveCodes ? menus.filter(item => effectiveCodes.has(item.code)) : menus;
